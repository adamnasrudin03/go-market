...
func (_m *AuthRepository) CheckIsDuplicate(ctx context.Context, input dto.UserDetailReq) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, dto.UserDetailReq) error); ok {
		r0 = rf(ctx, input)
	} else {
		r0 = ret.Error(0)
	}
